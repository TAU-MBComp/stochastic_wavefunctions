...
# ax1, ax2 = create_horizontal_split(fig, 2, xlabel=('Epoch', 'Epoch'), ylabel=(r'$E_\mathrm{VMC}$', 'Symmetry'),
...
ax1.plot(energy_loss1, color='teal')
ax1.axhline(y=2., color = 'k', linewidth=0.5, linestyle = '--', label='exact energy')
#ax.set_ylim(2.5, 6.2)
#ax.set_xlim(-0.02, 1.0)
ax1.legend()

ax3.semilogy(symmetry_loss1, color='indigo')
...
#ax.add_artist(ab)
ax2.plot(energy_loss2, color='teal')
ax2.axhline(y=4.5, color = 'k', linewidth=0.5, linestyle = '--', label='exact energy')
#ax.set_ylim(2.5, 6.2)
#ax.set_xlim(-0.02, 1.0)
ax4.legend()

ax4.semilogy(symmetry_loss2, color='indigo')
# Clean up and save:
